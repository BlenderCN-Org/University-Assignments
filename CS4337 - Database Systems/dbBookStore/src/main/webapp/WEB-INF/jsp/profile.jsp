                    ...
                    <tr>
                        <th>
                            <div class="wrapper">
                                ...
                                <input type="text" minlength="1" maxlength="20" placeholder="Enter First Name"
                                       name="fname" required>
                            </div>
                        </th>
                        <th>
                            <div class="wrapper">
                                ...
                                <input type="text" minlength="1" maxlength="20" x placeholder="Enter Last Name"
                                       name="lname" required>
                            </div>
                        </th>
                    </tr>
                    <tr>
                        ...
                        <th>
                            <div class="wrapper">
                                ...
                                <input type="email" maxlength="50" minlength="1" placeholder="Enter Email Address"
                                       name="email" required>
                            </div>
                        </th>
                    </tr>
                    <tr>
                        <th>
                            <div class="wrapper">
                                ...
                                <input type="text" minlength="1" maxlength="50" placeholder="Enter Address"
                        ...
                        <th>
                            <div class="wrapper">
                                ...
                                <input type="text" placeholder="Enter City" name="city" required minlength="1"
                                       maxlength="30">
                            </div>
                        </th>
                    </tr>
                    <tr>
                        ...
                        <th>
                            <div class="wrapper">
                                ...
                                <input type="text" placeholder="Enter Zip" name="zip" required minlength="5"
                                       maxlength="5">
                            </div>
                        </th>
                    </tr>
